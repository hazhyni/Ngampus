...
public class PTS implements Parcelable {
    ...
    public static final Creator<PTS> CREATOR = new Creator<PTS>() {
        @Override
        public PTS createFromParcel(Parcel in) {
            return new PTS(in);
        }
        @Override
        public PTS[] newArray(int size) {
            return new PTS[size];
        }
    };
